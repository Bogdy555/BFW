...
"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe" -NoLogo -NoProfile -ExecutionPolicy Bypass -File ".\Solution Items\Cmd Batches\BFW_ESP32_BuildCore.ps1" -ESPPack "%ESPPack%\" -ArduLibVer "%ArduLibVer%" -CCompiler "%CCompiler%" -CPPCompiler "%CPPCompiler%" -CompileFlags "%CompileFlags%" -CFlags "%CFlags%" -CPPFlags "%CPPFlags%" -CFiles "%CFiles%" -CPPFiles "%CPPFiles%"
