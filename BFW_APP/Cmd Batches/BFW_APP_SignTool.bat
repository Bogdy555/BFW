...
if exist ".\Binaries\BFW_APP_DLL\Debug\x86\BFW_DLL.dll" "%SignTool%" sign /f ".\Solution Items\Digital Certificates\BFW\BFW_SPC_PFX.pfx" /p "BFWSoftware" /a /t "http://timestamp.digicert.com" /fd sha256 /d "BFW" ".\Binaries\BFW_APP_DLL\Debug\x86\BFW_DLL.dll"
if exist ".\Binaries\BFW_APP_DLL\Debug\x64\BFW_DLL.dll" "%SignTool%" sign /f ".\Solution Items\Digital Certificates\BFW\BFW_SPC_PFX.pfx" /p "BFWSoftware" /a /t "http://timestamp.digicert.com" /fd sha256 /d "BFW" ".\Binaries\BFW_APP_DLL\Debug\x64\BFW_DLL.dll"
if exist ".\Binaries\BFW_APP_DLL\Release\x86\BFW_DLL.dll" "%SignTool%" sign /f ".\Solution Items\Digital Certificates\BFW\BFW_SPC_PFX.pfx" /p "BFWSoftware" /a /t "http://timestamp.digicert.com" /fd sha256 /d "BFW" ".\Binaries\BFW_APP_DLL\Release\x86\BFW_DLL.dll"
if exist ".\Binaries\BFW_APP_DLL\Release\x64\BFW_DLL.dll" "%SignTool%" sign /f ".\Solution Items\Digital Certificates\BFW\BFW_SPC_PFX.pfx" /p "BFWSoftware" /a /t "http://timestamp.digicert.com" /fd sha256 /d "BFW" ".\Binaries\BFW_APP_DLL\Release\x64\BFW_DLL.dll"
