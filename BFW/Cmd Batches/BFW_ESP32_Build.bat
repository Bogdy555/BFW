...
set Files=BFW_Assets BFW_Cryptography BFW_Debug BFW_GUI BFW_GUID BFW_EntryPoint BFW_Input BFW_Log BFW_Math BFW_Math_Matrix BFW_Math_Quaternion BFW_Math_Random BFW_Math_Vector BFW_Math BFW_MultiProcessing BFW_RunTime BFW_String BFW_Time
