...
set Files=BFW_Assets BFW_Cryptography BFW_Debug BFW_GUI BFW_GUID BFW_EntryPoint BFW_FileSystem BFW_Input BFW_Log BFW_Math BFW_Math_Matrix BFW_Math_Quaternion BFW_Math_Random BFW_Math_Vector BFW_Math BFW_MultiProcessing BFW_RunTime BFW_String BFW_Time
...
"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe" -NoLogo -NoProfile -ExecutionPolicy Bypass -File ".\BFW\Cmd Batches\BFW_ESP32_Build.ps1" -Compiler "%Compiler%" -CompileFlags "%CompileFlags%" -Files "%Files%" -Configuration "%Configuration%"
