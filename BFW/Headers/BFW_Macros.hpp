...
#define BFW_PROFILE_FUNCTION() BFW::Time::ScopeTimer BFW_CONCATENATE(_ScopeTimer, __LINE__)([](const BFW::Time::Timer& _ScopeTimer, const BFW_CHAR_TYPE* _File, const size_t _Line, const BFW_CHAR_TYPE* _Name) { BFW::Log::ProfilingFileMutex->lock(); BFW::Assets::Json& _Element = BFW::Log::ProfilingJson->GetObjectData().Object[1].GetArray().EmplaceBack(BFW::Assets::Json()); _Element.SetObject(); _Element.GetObjectData().Tags.PushBack("name"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetString(BFW::String::FromUnicodeToUTF8(_Name)); _Element.GetObjectData().Tags.PushBack("cat"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetString("function"); _Element.GetObjectData().Tags.PushBack("ph"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetString("X"); _Element.GetObjectData().Tags.PushBack("ts"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber((float)(BFW::Time::GetTimeStamp(_ScopeTimer.GetBegin()) - BFW::Log::ProfilingStart) / 1000.0f); _Element.GetObjectData().Tags.PushBack("dur"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber(_ScopeTimer * 1000000.0f); _Element.GetObjectData().Tags.PushBack("pid"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber((float)(BFW::MultiProcessing::Process::GetCurrentPid())); _Element.GetObjectData().Tags.PushBack("tid"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber((float)(std::hash<std::thread::id>()(std::this_thread::get_id()))); _Element.GetObjectData().Tags.PushBack("args"); BFW::Assets::Json& _Args = _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()); _Args.SetObject(); _Args.GetObjectData().Tags.PushBack("File"); _Args.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetString(BFW::String::FromUnicodeToUTF8(_File)); _Args.GetObjectData().Tags.PushBack("Line"); _Args.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber((float)(_Line)); BFW::Log::ProfilingFileMutex->unlock(); }, BFW_STRING_PREFIX(__FILE__), __LINE__, BFW_STRING_PREFIX(__FUNCTION__))
#define BFW_PROFILE_SCOPE(Name) BFW::Time::ScopeTimer BFW_CONCATENATE(_ScopeTimer, __LINE__)([](const BFW::Time::Timer& _ScopeTimer, const BFW_CHAR_TYPE* _File, const size_t _Line, const BFW_CHAR_TYPE* _Name) { BFW::Log::ProfilingFileMutex->lock(); BFW::Assets::Json& _Element = BFW::Log::ProfilingJson->GetObjectData().Object[1].GetArray().EmplaceBack(BFW::Assets::Json()); _Element.SetObject(); _Element.GetObjectData().Tags.PushBack("name"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetString(BFW::String::FromUnicodeToUTF8(_Name)); _Element.GetObjectData().Tags.PushBack("cat"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetString("scope"); _Element.GetObjectData().Tags.PushBack("ph"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetString("X"); _Element.GetObjectData().Tags.PushBack("ts"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber((float)(BFW::Time::GetTimeStamp(_ScopeTimer.GetBegin()) - BFW::Log::ProfilingStart) / 1000.0f); _Element.GetObjectData().Tags.PushBack("dur"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber(_ScopeTimer * 1000000.0f); _Element.GetObjectData().Tags.PushBack("pid"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber((float)(BFW::MultiProcessing::Process::GetCurrentPid())); _Element.GetObjectData().Tags.PushBack("tid"); _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber((float)(std::hash<std::thread::id>()(std::this_thread::get_id()))); _Element.GetObjectData().Tags.PushBack("args"); BFW::Assets::Json& _Args = _Element.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()); _Args.SetObject(); _Args.GetObjectData().Tags.PushBack("File"); _Args.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetString(BFW::String::FromUnicodeToUTF8(_File)); _Args.GetObjectData().Tags.PushBack("Line"); _Args.GetObjectData().Object.EmplaceBack(BFW::Assets::Json()).SetNumber((float)(_Line)); BFW::Log::ProfilingFileMutex->unlock(); }, BFW_STRING_PREFIX(__FILE__), __LINE__, Name)
