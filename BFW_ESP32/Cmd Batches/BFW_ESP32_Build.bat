...
xtensa-esp32s3-elf-g++ "-Wl,--Map=.\Binaries\BFW_ESP32\%Configuration%\BFW_ESP32.map" "-L%ESPPack%tools\esp32-arduino-libs\idf-release_v5.4-2f7dcd86-v1\esp32s3\lib\\" "-L%ESPPack%tools\esp32-arduino-libs\idf-release_v5.4-2f7dcd86-v1\esp32s3\ld\\" "-L%ESPPack%tools\esp32-arduino-libs\idf-release_v5.4-2f7dcd86-v1\esp32s3\qio_opi\\" -Wl,--wrap=esp_panic_handler "@%ESPPack%tools\esp32-arduino-libs\idf-release_v5.4-2f7dcd86-v1\esp32s3\flags\ld_flags" "@%ESPPack%tools\esp32-arduino-libs\idf-release_v5.4-2f7dcd86-v1\esp32s3\flags\ld_scripts" -Wl,--start-group ".\Objects\BFW_ESP32\%Configuration%\BFW_ESP32_Application.o" ".\Objects\BFW_ESP32\%Configuration%\BFW_ESP32_EntryPoint.o" ".\Objects\BFW_ESP32\%Configuration%\BFW_ESP32_MainMenu.o" ".\Solution Items\Dependencies\ArduinoCore\Lib\ArduinoCore.a" ".\Binaries\BFW_STATIC\ESP32\%Configuration%\BFW_STATIC.a" "@%ESPPack%tools\esp32-arduino-libs\idf-release_v5.4-2f7dcd86-v1\esp32s3\flags\ld_libs" -Wl,--end-group -Wl,-EL -o ".\Binaries\BFW_ESP32\%Configuration%\BFW_ESP32.elf"
