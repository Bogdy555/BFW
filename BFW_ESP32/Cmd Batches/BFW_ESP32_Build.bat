...
set Files=BFW_ESP32_EntryPoint BFW_ESP32_RunTime_Application BFW_ESP32_RunTime_MainMenu
...
for %%i in (%Files%) do (
	set AllObj=!AllObj! ".\Objects\BFW_ESP32\%Configuration%\%%i.o"
)
